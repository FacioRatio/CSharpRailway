...
{
    public class ResultBindTupleABCDExtensionsTests
    {
        [Fact]
        public void BindTuple_ABCDResultE_Fails()
        {
            var sut = Result.Fail<(string, int, short, long)>("fail");

            var result = sut.BindTuple((s, i, h, l) => Result.Ok('!'));
        ...
        [Fact]
        public void BindTuple_ABCDResultE_Succeeds()
        {
            var sut = Result.Ok(("success", 1, (short)1, (long)1));
        ...
        [Fact]
        public void BindTuple_ABCDE_Fails()
        {
            var sut = Result.Fail<(string, int, short, long)>("fail");

            var result = sut.BindTuple((s, i, h, l) => '!');
        ...
        [Fact]
        public void BindTuple_ABCDE_Succeeds()
        {
            var sut = Result.Ok(("success", 1, (short)1, (long)1));
