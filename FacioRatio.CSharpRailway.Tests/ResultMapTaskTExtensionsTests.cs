...
{
    public class ResultMapTaskTExtensionsTests
    {
        //[Fact]
        ...
        [Fact]
        public async Task Map_TaskResultIEnumerable_ResultU_Works()
        {
            var items = Task.FromResult(Result.Ok(Enumerable.Range(1, 1)));
        ...
        [Fact]
        public async Task Map_TaskResultIEnumerable_TaskResultU_Works()
        {
            var items = Task.FromResult(Result.Ok(Enumerable.Range(1, 1)));
        ...
        [Fact]
        public async Task Map_TaskResultIEnumerable_U_Works()
        {
            var items = Task.FromResult(Result.Ok(Enumerable.Range(1, 1)));
        ...
        [Fact]
        public async Task Map_TaskResultIEnumerable_TaskU_Works()
        {
            var items = Task.FromResult(Result.Ok(Enumerable.Range(1, 1)));
        ...
        [Fact]
        public async Task Map_TaskResultList_ResultU_Works()
        {
            var items = Task.FromResult(Result.Ok(Enumerable.Range(1, 1).ToList()));
        ...
        [Fact]
        public async Task Map_TaskResultList_TaskResultU_Works()
        {
            var items = Task.FromResult(Result.Ok(Enumerable.Range(1, 1).ToList()));
        ...
        [Fact]
        public async Task Map_TaskResultList_U_Works()
        {
            var items = Task.FromResult(Result.Ok(Enumerable.Range(1, 1).ToList()));
        ...
        [Fact]
        public async Task Map_TaskResultList_TaskU_Works()
        {
            var items = Task.FromResult(Result.Ok(Enumerable.Range(1, 1).ToList()));
