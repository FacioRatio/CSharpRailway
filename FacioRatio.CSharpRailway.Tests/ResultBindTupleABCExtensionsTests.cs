...
{
    public class ResultBindTupleABCExtensionsTests
    {
        [Fact]
        public void BindTuple_ABCResultD_Fails()
        {
            var sut = Result.Fail<(string, int, short)>("fail");

            var result = sut.BindTuple((s, i, h) => Result.Ok((long)1));
        ...
        [Fact]
        public void BindTuple_ABCResultD_Succeeds()
        {
            var sut = Result.Ok(("success", 1, (short)1));
        ...
        [Fact]
        public void BindTuple_ABCD_Fails()
        {
            var sut = Result.Fail<(string, int, short)>("fail");

            var result = sut.BindTuple((s, i, h) => (long)1);
        ...
        [Fact]
        public void BindTuple_ABCD_Succeeds()
        {
            var sut = Result.Ok(("success", 1, (short)1));
